...
const ActionButton = props => {
  ...
  const _renderMainButton = () => {
    ...
    return (
      <View style={[parentStyle, !props.hideShadow && shadowStyle, !props.hideShadow && props.shadowStyle]}>
        <Touchable
          testID={props.testID}
          ...
          <Animated.View style={wrapperStyle}>
            <Animated.View style={[buttonStyle, animatedViewStyle]}>{_renderButtonIcon()}</Animated.View>
          </Animated.View>
        </Touchable>
      </View>
    );
