...
export default class ActionButtonItem extends Component {
  ...
  _renderTitle() {
    ...
    const { textContainerStyle, hideLabelShadow, offsetX, parentSize, size, position, spaceBetween, numberOfLines } =
      this.props;
    ...
    const title = React.isValidElement(this.props.title) ? (
      ...
      <Text allowFontScaling={false} style={[styles.text, this.props.textStyle]} numberOfLines={numberOfLines}>
        {this.props.title}
      </Text>
    );
